...
public class Constants {
    ...
    static final int FRONT_LEFT_MOTOR_ID = 14;
    // static final int MIDDLE_LEFT_MOTOR_ID = 7;
    static final int BACK_LEFT_MOTOR_ID = 15;
    static final int FRONT_RIGHT_MOTOR_ID = 1;
    // static final int MIDDLE_RIGHT_MOTOR_ID = 10;
    static final int BACK_RIGHT_MOTOR_ID = 16;
    ...
    public class DriveConstants {
        ...
        public static final double WHEEL_DIAMETER = .2032; // in meters
        public static final double GEARING_CONVERSION = 5/24;
        ...
        public static final double TRACK_WIDTH = 20.7; // width bewteen each side of drive train in meters

        // constants from robot characterization tool
        public static final double ks = 0.622;//.23
        public static final double kv = 0.00247;//1.2
        public static final double ka = 0.000355;//.326

        // tuned constant, tuned like an P value, look for oscillation 
        public static final double DriveP = 0.0165;//6
